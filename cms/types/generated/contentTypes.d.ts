...
export interface ApiCareerHighlightCareerHighlight
  extends Struct.CollectionTypeSchema {
  collectionName: 'career_highlights';
  info: {
    description: 'A company value or employee perk shown on the careers page.';
    displayName: 'Career Highlight';
    pluralName: 'career-highlights';
    singularName: 'career-highlight';
  };
  options: {
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<['value', 'perk']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'value'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::career-highlight.career-highlight'
    > &
      Schema.Attribute.Private;
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client/brand logo shown in the homepage logo strip.';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Frequently asked question, per region.';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
...
export interface ApiHomepageHomepage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Hero content for one region's homepage. One entry per region.";
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  collectionName: 'jobs';
  info: {
    description: 'An open position listed on the careers page.';
    displayName: 'Job';
    pluralName: 'jobs';
    singularName: 'job';
  };
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A Beacon office shown on the contact page, grouped by country tab.';
    displayName: 'Office';
    pluralName: 'offices';
    singularName: 'office';
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic marketing page, scoped to a region.';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPartnerBenefitPartnerBenefit
  extends Struct.CollectionTypeSchema {
  collectionName: 'partner_benefits';
  info: {
    description: 'A benefit of partnering with Beacon, shown on the partners page.';
    displayName: 'Partner Benefit';
    pluralName: 'partner-benefits';
    singularName: 'partner-benefit';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::partner-benefit.partner-benefit'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog article. Replaces the Sanity-backed blog on the global site.';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A keyed content block on a page \u2014 heading, copy and an optional list of cards. Used for sections that exist on only some regions, so each one does not need its own content type.';
    displayName: 'Section';
    pluralName: 'sections';
  ...
  attributes: {
    ...
    cards: Schema.Attribute.Component<'section.card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service offering (incorporation, tax, advisory...), per region.';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Company-wide contact details and social links used in the header and footer.';
  ...
  attributes: {
    copyrightHolder: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    officeMapUrl: Schema.Attribute.String;
    phones: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An animated counter in the green stats banner.';
    displayName: 'Stat';
    pluralName: 'stats';
    singularName: 'stat';
  };
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A client quote shown in the testimonial carousel.';
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::partner-benefit.partner-benefit': ApiPartnerBenefitPartnerBenefit;
